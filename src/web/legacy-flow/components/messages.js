const MessagesView = {
    ...
    async send(pid) {
        ...
        // Keep the editor content until the API confirms success — disable input
        // during the request but do NOT clear it, so nothing is lost on failure.
        ...
        try {
            ...
            // Confirmed sent — now safe to clear the editor.
            this.quill.setText('');
            ...
            // Editor content was never cleared, so the message is preserved for retry.
        } finally {
