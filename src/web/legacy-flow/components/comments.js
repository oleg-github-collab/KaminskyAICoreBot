const CommentsView = {
    ...
    async submitComment(parentId = null) {
        ...
        // Disable editor during the request; keep content until success.
        ...
        try {
            ...
            // Re-enable the editor (content preserved) and offer a retry.
            this.quill.enable(true);
            this.quill.focus();
            App.toast(e.message + ' — натисніть «Додати», щоб повторити', 'error');
        }
    },
