...
pub const use_app = "⚠️ Для роботи відкрийте застосунок (кнопка нижче). Тут лише сповіщення!";
...
pub const help =
    ...
    \\━━━━━━━━━━━━━━━━━━━━
    \\<b>⚠️ ВАЖЛИВО!</b>
    \\Робота тільки в застосунку!
    \\Бот = лише сповіщення
    \\━━━━━━━━━━━━━━━━━━━━
    \\
    \\<b>🚀 КРОК 1: Відкрити застосунок</b>
    \\
    \\<b>На телефоні:</b>
    ...
    \\━━━━━━━━━━━━━━━━━━━━
    \\<b>💬 Підтримка:</b>
    \\Використовуйте чат в застосунку або натисніть «Написати спеціалісту»
    \\
    \\🌐 Більше: <b>kaminskyi.chat</b>
;
