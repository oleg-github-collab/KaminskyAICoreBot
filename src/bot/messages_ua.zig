...
pub const welcome_user =
    ...
    \\
    \\<b>Два способи доступу:</b>
    \\1️⃣ <b>Міні-застосунок Telegram</b> — натисніть кнопку "Застосунок" нижче
    \\2️⃣ <b>Повноцінний веб-інтерфейс</b> — відкрийте у браузері:
    \\   https://bot-production-d5ec.up.railway.app
    \\
    \\Обидва інтерфейси повністю синхронізовані — всі ваші проєкти, файли та глосарії доступні в обох режимах.
    \\
...
pub const help =
    ...
    \\
    \\1️⃣ <b>Відкрийте застосунок:</b>
    \\   • Міні-застосунок Telegram (кнопка "Застосунок" нижче)
    \\   • Веб-інтерфейс: https://bot-production-d5ec.up.railway.app
    \\
    \\2️⃣ Створіть проєкт та завантажте файли
    \\3️⃣ Оплатіть послугу
    \\4️⃣ Отримайте готовий глосарій та переклад
    \\
    \\<b>Вартість:</b>
    \\• Текстові файли: €0.58 за кожні 1800 символів
    \\• PDF та документи: €0.89 за кожні 1800 символів
    \\
    \\<b>Два режими роботи:</b>
    \\• <b>Міні-застосунок</b> — швидкий доступ прямо в Telegram
    \\• <b>Веб-версія</b> — повноцінний інтерфейс для роботи на комп'ютері
    \\
    \\Всі дані повністю синхронізовані між двома режимами!
    \\
